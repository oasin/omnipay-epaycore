...
processing library for PHP 7.2+. This package implements Epaycore support for Omnipay.
...
The following gateways provided by this package:
  ...
  * PerfEpaycoreectMoney

For general usage instructions, please see the main [Omnipay](https://github.com/omnipay/omnipay)
repository. See [Epaycore Documentation](https://perfectmoney.is/sample-api.html)

## Example
 1. Purchase:
```php
$gateway = Omnipay::create('EpayCore');
