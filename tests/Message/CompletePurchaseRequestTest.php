...
namespace Omnipay\EpayCore\Tests\Message;

use Mockery as m;
use Omnipay\EpayCore\Message\CompletePurchaseRequest;
...
class CompletePurchaseRequestTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = (new m)->mock('Omnipay\EpayCore\Message\CompletePurchaseRequest[getEndpoint]', $arguments);
